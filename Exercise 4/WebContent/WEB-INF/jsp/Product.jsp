...
<p> <fmt:message key="price" bundle="${labels}"/> : <fmt:message key="currency" bundle="${labels}"></fmt:message><fmt:formatNumber value="${sessionScope.price0}" type="currency" currencySymbol=""/> </p>
...
<p> <fmt:message key="price" bundle="${labels}"/> : <fmt:message key="currency" bundle="${labels}"></fmt:message><fmt:formatNumber value="${sessionScope.price1}" type="currency" currencySymbol=""/> </p>
